...
class DatePickerDialog: UIView {
    ...
    func show(title: String, doneButtonTitle: String, cancelButtonTitle: String, defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode, callback: ((date: NSDate) -> Void)) {
        self.title = title
    ...
    private func createContainerView() -> UIView {
        ...
        self.datePicker.locale = NSLocale(localeIdentifier: "pt_BR")
